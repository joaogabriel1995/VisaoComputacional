...
class BoxTexto:
    ...
    def visualizar_img(self, nome_janela="Imagem"):

        cv2.imshow(str(nome_janela), self.Imagem)
        cv2.waitKey(0)
    ...
    def escreve_texto(self, texto, x, y, img, fonte=r"D:\Arquivos Pessoais\Faculdade\Python\Tesseract\Fontes\calibri.ttf", tamanho_texto=32):
        ...
        draw.text((x, y - tamanho_texto), texto, font=fonte, fill="#000") #escolhemos a posição x, a posição y deslocamos o tamanho do texto para ficar uniforme, texto e fonte
...
if __name__=="__main__":
    ...
    image_path = r"D:\Arquivos Pessoais\Faculdade\Python\Tesseract\imagens\Post2-imagem1.png"
